...
cmds = [
        ...
        ["mpirun", "-np", "16", "-H", "localhost:16", "--bind-to", "hwthread",  "python3", "hessian_horovod_train.py", "--num-cores", "16", "--lr", "0.01"],
        ["mpirun", "-np", "16", "-H", "localhost:16", "--bind-to", "hwthread","python3", "hessian_horovod_train.py",  "--num-cores", "16", "--lr", "0.01", "--batch-mult", "2"],
        ["mpirun", "-np", "16", "-H", "localhost:16", "--bind-to", "hwthread", "python3", "hessian_horovod_train.py", "--num-cores", "16", "--lr", "0.01", "--batch-mult", "4"],
        ["mpirun", "-np", "16", "-H", "localhost:16", "--bind-to", "hwthread", "python3", "horovod_train.py", "--num-cores", "16", "--lr", "0.01"],
        # ["mpirun", "-np", "16", "-H", "localhost:16", "--bind-to", "hwthread",  "python3", "hessian_horovod_train.py", "--num-cores", "16", "--init-batch-size", "32"],
        ...
        # ["mpirun", "-np", "16", "-H", "localhost:16", "--bind-to", "hwthread", "python3", "hessian_horovod_train.py", "--num-cores", "16", "--eig-comm", "0"],
        ]
